...
export default function AddToCartButton({ productId, loggedIn, large = false, mini = false, quantity = 1 }: Props) {
  ...
  if (mini) {
    return (
      <button
        ...
        className={`flex items-center justify-center w-7 h-7 rounded-full transition-colors duration-200 shrink-0
