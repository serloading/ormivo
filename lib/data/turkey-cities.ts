export const TURKEY_CITIES: Record<string, string[]> = {
  ...
  "Afyonkarahisar": ["Afyonkarahisar Merkez","Başmakçı","Bayat","Bolvadin","Çay","Çobanlar","Dazlıca","Dinar","Emirdağ","Evciler","Hocalar","İhsaniye","İscehisar","Kızılören","Sandıklı","Sinanpaşa","Sultandağı","Şuhut"],
  ...
  "Bilecik": ["Bozüyük","Gölpazarı","İnhisar","Osmaneli","Pazaryeri","Pomukova","Söğüt","Yenipazar"],
  ...
  "Isparta": ["Aksu","Atabey","Eğirdir","Gelendost","Gönen","Keçiborlu","Isparta Merkez","Şarkikaraağaç","Senirkent","Sütçüler","Uluborlu","Yalvaç","Yenişarbademli"],
...
export const CITY_NAMES = ["Yurt Dışı", ...Object.keys(TURKEY_CITIES).sort()];
