              ...
              <div key={order.id} className="border border-[#E8E4DE]">
                ...
                {isOpen && (
                  <div className="border-t border-[#E8E4DE] px-4 pb-4 pt-3">
                    ...
                    {/* WhatsApp: ülke kodu + gönder butonu */}
                    <div className="flex items-center gap-2">
                      <select
                        value={countryCode}
                        onChange={(e) => setCountryCode(e.target.value)}
                        className="border border-[#E8E4DE] text-xs px-2 py-1.5 text-[#4A4A4A] bg-white focus:outline-none focus:border-[#C4A882] shrink-0"
                      >
                        {COUNTRY_CODES.map((c) => (
                      ...
                      <a
                        ...
                        className="flex items-center gap-2 bg-[#25D366] text-white px-3 py-1.5 rounded-full hover:bg-[#1ebe5d] transition-colors"
                      >
