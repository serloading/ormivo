            ...
            return (
              <div key={order.id} className="border border-[#E8E4DE] p-4">
                ...
                <div className="flex items-center justify-between pt-0">
                  ...
                  {/* Mini WhatsApp butonu */}
                  <a
                    href={waUrl}
                    target="_blank"
                    rel="noopener noreferrer"
                    title="Sipariş özetini kendine gönder"
                    className="flex items-center justify-center w-8 h-8 bg-[#25D366] text-white rounded-full hover:bg-[#1ebe5d] transition-colors shrink-0"
                  >
